...
/**
 	...
 	* Este método se utiliza para devolver un mensaje de saludo.
 	* 
 	*
...
/**
 	...
 	* Este método se usa para realizar operaciones matemáticas sencillas.
 	*

 	* @param x tipo Int. El número con el que quieres operar.
 	* @param y tipo Int. El número con el que quieres operar.
 	* @param op tipo String. La operación que quieres realizar.
 	* 
 	* @return  
 	* 
 	*<ul>
